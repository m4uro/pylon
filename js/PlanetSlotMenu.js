...
//        aux = game.add.button(this.x, this.y, 'icons', null, this, iName+'0001', iName+'0000', iName+'0006', iName+'0001');
...
//        aux.onInputUp.add(this.optionClicked(point.x, point.y), this);
    ...
    //TODO hide other slots, remove clickability on this slot
    this.inputEnabled = false;
    Py.selected.planet.hideSlotsToBuild(this);
    
//    this.buildingOptions.forEach(function(option) {
//    	option.onInputUp.add(this.optionClicked(this.x, this.y), this);
//    }, this);
}
...
Pylon.PlanetSlotMenu.prototype.optionClicked = function(button, pointer) {
    ...
    sprite = game.add.sprite(button.x, button.y, bmd);
    sprite.alpha = 0.6;
    info.add(sprite);
    info.sendToBack(sprite);
